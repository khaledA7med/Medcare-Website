...
?>
    ...
    <section class="home" id="home">
        ...
        <div class="image" >
            ...
            <a style="margin-left: 520px;" href="chatbot.php" class="btn"> chat with us <span class="fas fa-chevron-right"></span> </a>
        </div>
        </div>
...
?>
            ...
            <a href="popularDest.html"><img src="admin/design/images/<?php echo $campaign['c_pic'] ?>" 
            alt="campaign" style="width:100%;height:550px"></a>
...
?>
    ...
    <section class="chatbot" style="background-color: #eee;">
        <div class="chat-popup" style="width: 550px; height: 75vh; right: 120px; bottom:50px; background-color:#30B9D8;">
            <div class="chat-area">
